...
const cameraMotionLabels: Record<string, string> = {
  automatic: "Automatische Empfehlung",
  slow_dolly_in: "Langsamer Dolly-In",
  lateral_slide: "Sanfte Seitwärtsbewegung",
  doorway_entrance: "Eingang durch die Tür",
  slow_pan: "Langsamer Pan",
